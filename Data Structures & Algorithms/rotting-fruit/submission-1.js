class Solution {
    ...
    orangesRotting(grid) {
        ...
        // check if there are any fresh oranges remaining that were not able to be rotted
        return fresh === 0 ? minutes : -1; // remove 1 from minutes to account for last level
    }
}
