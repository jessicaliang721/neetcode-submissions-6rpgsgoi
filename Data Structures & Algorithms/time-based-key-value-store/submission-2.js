class TimeMap {
    ...
    get(key, timestamp) {
        ...
        let res = ""; // need to store result so you can find the latest (closest) timestamp ≤ target
        ...
        while (l <= r) {
            ...
            if (midTimestamp <= timestamp) { // this is allowed because we want the largest prev timestamp
                // toss out left half
